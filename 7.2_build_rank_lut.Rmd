...
params:
  ...
  # ---- matched persistence-prioritization run ----
  ...
  rank_path: "Data/Results/BenchmarkRankMaps/rankmap_abf_178.tif"
  species_csv: "Data/Clean/species_table.csv"
  patch_dir: "Data/Clean/Patches"

  # ---- outputs, under pipeline_output_dir/ana/<lut_dir>/ ----
  lut_dir: "rank_lut_abf_178"
  lut_prefix: "lut_stage_"
  target_summary_name: "rank_stage_targets_abf_178.csv"
  inventory_name: "rank_lut_inventory_abf_178.csv"

  # ---- matching behavior ----
  match_basis: "area"              # "area" or "cells"; use "area" for main analysis
  rank_higher_is_better: true      # true if higher rank values should be retained first
  include_stage0: true
...
target_summary_csv <- file.path(lut_root, as.character(params$target_summary_name))
inventory_csv <- file.path(lut_root, as.character(params$inventory_name))
...
need_file(rank_path, "benchmark rank map")
