---
title: "6_spatial_prioritization_pipeline_minimal"
...
pruning_input_bundle_dir <- file.path("Data", "Clean", "PruningTestInputs")
...
run_priority_pipeline <- function(
  ...
  # -------------------------------------------------------------------
  # 9. Write the final removal-order raster once
  # -------------------------------------------------------------------
  ...
  # -------------------------------------------------------------------
  # 10. Compute compact final-run summaries
  # -------------------------------------------------------------------
  ...
  # -------------------------------------------------------------------
  # 11. Return the final in-memory state and output paths
  # -------------------------------------------------------------------
...
pipeline_output_dir <- file.path(
  "Data", "Clean", "PriorityPipelineTest",
  sprintf(
