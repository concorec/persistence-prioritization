...
rank_lut_root <- file.path(ana, paste0("rank_lut_", rank_method))
...
out_root <- file.path(ana, paste0("persist_cmp_", rank_method))
dir.create(out_root, recursive = TRUE, showWarnings = FALSE)

out_pu <- file.path(out_root, paste0("pu_long_", rank_method, ".csv"))
out_sp <- file.path(out_root, paste0("sp_long_", rank_method, ".csv"))
out_stage <- file.path(out_root, paste0("stage_sum_", rank_method, ".csv"))
out_compare <- file.path(out_root, paste0("stage_compare_", rank_method, ".csv"))
