...
params:
  ...
  out_subdir: "persist_cmp_abf"
  pu_long_name: "pu_long_abf.csv"
  sp_long_name: "sp_long_abf.csv"
  stage_sum_name: "stage_sum_abf.csv"
  stage_compare_name: "stage_compare_abf.csv"
...
focal_name <- if (!is.null(params$focus_species) && length(params$focus_species) >= 1L) {
  ...
  "Galidia elegans" # "Hapalemur alaotrensis", "Pterocles personatus", "Galidia elegans"
}
